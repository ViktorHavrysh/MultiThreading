...
namespace DataRace
{
    public static class Fooinator
    {
        ...
        // Values of other types—including user-defined value types—could be written into memory in multiple atomic
        // writes. As a result, a reading thread could observe a torn value consisting of pieces of different values.
